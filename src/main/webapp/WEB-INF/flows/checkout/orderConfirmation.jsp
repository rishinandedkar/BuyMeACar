...
<div class="container-wrapper">
    <div class="container">
        <div class="page-header">
            <title>Order</title>
            <p class="lead">Order Confiramtion</p>
        </div>
            ...
            <div class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
                ...
                <div class="row">
                    <table class="table table-hover">
                        ...
                        <tbody>
                        <c:forEach car="cartItem" items="${order.cart.cartItems}">
                            <tr>
        ...
        <br><br>
        <button class="btn btn-default" name="_eventId_backToCollectShippingDetail">Cancel</button>
